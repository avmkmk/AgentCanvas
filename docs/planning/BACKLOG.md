...
| BA-15 | Agent CRUD endpoints: POST/GET/PATCH/DELETE /flows/{id}/agents — reconcile AgentCreate/AgentResponse schemas with Agent ORM (type, system_prompt, model_name, no step_order) | critical | M2 | open |
